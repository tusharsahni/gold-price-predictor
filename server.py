...
# Load and prepare the data
gold_data_path = r'C:\Users\tusha\OneDrive\Desktop\gold price predictor\gld_price_data.csv'
...
def serve_file(filename):
    directory = os.path.dirname(gold_data_path)  # Directory containing the CSV file
